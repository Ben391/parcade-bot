...
server_id = 407541003004936203
test_channel_id = 898635377512960120
test_message_id = 901503403849547786

announcement_role_id = 901504479952789516
update_role_id = 901505317236510761
network_status_id = 901505773312552980

default_role_id = 898636957385646110
gold_role_id = 898636545895043093
vip_role_id = 469355528418623498


def dbconnection():
    playerdb = mysql.connector.connect(
        host="panel.parcade.net",
        user="parcade",
        password="Zr4$p)7%d86mCds5$rth=24dh",
        database="parcade")
    return playerdb
...
async def upgrade_particle(ctx, message_id):
    channel = bot.get_channel(407541003499732993)
    if ctx.channel.id == 1074791727208091689:
        try:
        ...
        await ctx.send("Wrong Channel or lacking required Permission.")

bot.run('OTAxNTAwNjk5OTQ1MzYxNDI4.YXQx8w.9VxYY2rehlRaAtFt0Hddzf3sHII')
